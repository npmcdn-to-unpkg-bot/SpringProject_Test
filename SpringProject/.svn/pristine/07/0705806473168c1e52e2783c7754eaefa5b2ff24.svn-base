...
<form name="boardWriteForm" class="boardWriteForm-form" method="post" action="/SpringProject/board/boardWrite.do">
<span class="btn_big" onclick="location.href='/SpringProject/template/freeBoard.do'"><span>목록</span></span>
		<div class="body">
